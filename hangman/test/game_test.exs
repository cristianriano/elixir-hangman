defmodule GameTest do
  ...
  test "guesses can't be numbers" do
    { game, _ } = Game.new_game() |> Game.make_move("1")
    assert game.game_state == :invalid_guess
  end

  test "guesses can't be multiple letters" do
    { game, _ } = Game.new_game() |> Game.make_move("ar")
    assert game.game_state == :invalid_guess
  end
  ...
  test "a good guess is recognized" do
    { game, _ } = Game.new_game("yes") |> Game.make_move("y")
  ...
  test "a bad guess is recognized" do
    { game, _ } = Game.new_game("yes") |> Game.make_move("x")
